...
class ModelResourceIT {
    ...
    public static Model createEntity(EntityManager em) {
        Model model = new Model().label(DEFAULT_LABEL).year(DEFAULT_YEAR);
        return model;
    }
    ...
    public static Model createUpdatedEntity(EntityManager em) {
        Model model = new Model().label(UPDATED_LABEL).year(UPDATED_YEAR);
        return model;
    }
    ...
    void putNewModel() throws Exception {
        ...
        updatedModel.label(UPDATED_LABEL).year(UPDATED_YEAR);
    ...
    void fullUpdateModelWithPatch() throws Exception {
        ...
        partialUpdatedModel.label(UPDATED_LABEL).year(UPDATED_YEAR);
