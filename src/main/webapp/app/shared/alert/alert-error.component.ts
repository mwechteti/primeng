      ...
      switch (httpErrorResponse.status) {
        ...
        case 400: {
          ...
          if (errorHeader) {
            ...
            this.addErrorAlert(
              (httpErrorResponse.error.detail ?? httpErrorResponse.error.message) as string,
              httpErrorResponse.error.message as string,
              httpErrorResponse.error.params as { [key: string]: unknown; }
            );
          } else {
            this.addErrorAlert(httpErrorResponse.error as string , httpErrorResponse.error as string );
          }
          break;
        }
